...
Since I couldn't identify the cause of the discrepancy, I decided to copy the HTML table from [https://db.ipc-services.org/sdms/hira/web/paralympians](https://db.ipc-services.org/sdms/hira/web/paralympians).
